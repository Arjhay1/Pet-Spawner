...
titleBar.BackgroundColor3   = Color3.fromRGB(180, 0, 0)  -- bright red
...
main.BackgroundColor3       = Color3.fromRGB(25, 0, 0)  -- dark maroon inner
...
tabBtn.BackgroundColor3 = Color3.fromRGB(120, 0, 0)  -- mid red
...
local function makeDropdown(labelText, items)
    ...
    btn.BackgroundColor3 = Color3.fromRGB(120, 0, 0)  -- mid red
    ...
    opts.Visible          = false
    opts.BackgroundColor3 = Color3.fromRGB(120, 0, 0)
    ...
    for i,v in ipairs(items) do
        ...
        e.BackgroundColor3 = Color3.fromRGB(160, 0, 0)  -- brighter popup
        e.BorderSizePixel  = 0
...
local function makeBox(labelText, placeholder)
    ...
    box.BackgroundColor3 = Color3.fromRGB(100, 0, 0)  -- darker accent
...
spawnBtn.BackgroundColor3 = Color3.fromRGB(200, 0, 0)  -- bright accent
